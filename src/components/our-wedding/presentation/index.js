	...
	return (
		<>
			<div className={s.container}>
				...
				<h1 className={s.title}>A Cerimônia</h1>
				<span className={s.description}>
					A cerimônia vai ocorrer na <a className={s.link} onClick={() => router.push(window.open(QUADRANGULAR_MAPS_LINK, '_blank'))}>Igreja Quadrangular do Jardim Novo Campos Elíseos</a> no dia 7 de setembro de 2024 às 17h.
					Você pode encontrar algumas dicas para a cerimônia <a className={s.link} onClick={() => setOpen(true)}>clicando aqui</a>.
